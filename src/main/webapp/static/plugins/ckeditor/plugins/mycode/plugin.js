			...
			exec: function() {
				...
				if(!(!text || text == null || text.length == 0)){
					...
					if($("#ckeditor-codeModal").length == 0){
						$(drewcodeModal()).appendTo("body").modal("show");
					}else{
					...
					typer.on("change",function(){
						...
						if(type == "code"){
							container.html("<textarea class='form-control' id='ckeditor-code-textarea' style='height:300px'></textarea>");
						}
					});
					btn.off("click");
